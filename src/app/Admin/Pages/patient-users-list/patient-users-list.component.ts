...
@Component({
  selector: 'app-patient-users-list',
  templateUrl: './patient-users-list.component.html',
  styleUrls: ['./patient-users-list.component.scss']
})
export class PatientUsersListComponent implements OnInit {
