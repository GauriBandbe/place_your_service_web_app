...
@Component({
  selector: 'app-hospital-users-list',
  templateUrl: './hospital-users-list.component.html',
  styleUrls: ['./hospital-users-list.component.scss']
})
export class HospitalUsersListComponent implements OnInit {
